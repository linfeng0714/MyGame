// 家具(通用)
Shader "Block/Block_Fitment_Glass_Tex"
{
	Properties
	{
		...
		// 菲涅尔CubeMap反射(只在面板设置用)
		[Header(Fresnel Reflect)]
		_Cubemap("Cubemap", Cube) = "_Skybox" {}
		_Glossiness("Glossiness", Range(0, 1)) = 0.6     // 反光度(cubemap采样比重)
		_FresnelThickness("Fresnel Thickness", Range(0,5)) = 2 // 菲涅尔指数
		_EmissiveColor("Emissive Color", Color) = (1,1,1,1) // 菲涅尔自发光颜色
