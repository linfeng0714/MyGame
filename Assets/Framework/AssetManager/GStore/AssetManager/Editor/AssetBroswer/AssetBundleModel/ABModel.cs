...
namespace AssetBundleBrowser.AssetBundleModel
{
    ...
    public static class Model
    {
        ...
        //private static Dictionary<string, BundleInfo> dicBundleInfo = new Dictionary<string, BundleInfo>();
        ...
        public static bool Update()
        {
            ...
            assetCount = s_BundlesToUpdate.Count;
            if (size > 0)
            {
        ...
        internal static string[] ValidateBundleList()
        {
            ...
            //由于我们bundleName有后缀，屏蔽以下的校验方法才能正常工作
            return bundleList;
            //bool valid = true;
