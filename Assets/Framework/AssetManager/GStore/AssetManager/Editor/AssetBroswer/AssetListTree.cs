...
namespace AssetBundleBrowser
{
    internal class AssetListTree : TreeView
    {
        ...
        private static MultiColumnHeaderState.Column[] GetColumns()
        {
            ...
            retVal[4].headerContent = new GUIContent("", "Whether Don't Destroy in scene");
            retVal[4].minWidth = 2;
            retVal[4].width = 6;
            retVal[4].maxWidth = 8;
            ...
            retVal[4].allowToggleVisibility = true;
        ...
        {
            //Debug.Log("---asset---" + args.GetNumVisibleColumns());
            ...
            switch (column)
            {
                ...
                case 4:
                    ...
                    if (toggleRect.xMax < cellRect.xMax)
                        item.asset.isFolder = EditorGUI.Toggle(toggleRect, item.asset.isFolder);*/
                    break;
            }
            GUI.color = oldColor;
        }
        ...
        IOrderedEnumerable<AssetBundleModel.AssetTreeItem> InitialOrder(IEnumerable<AssetBundleModel.AssetTreeItem> myTypes, int[] columnList)
        {
            ...
            switch (sortOption)
            {
                ...
                case SortOption.DontDestroy:
                    return myTypes.Order(l => l.asset.isFolder, ascending);
