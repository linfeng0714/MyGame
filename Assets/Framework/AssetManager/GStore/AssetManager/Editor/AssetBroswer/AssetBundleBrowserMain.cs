...
namespace AssetBundleBrowser
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        public static dMessage mOnFocus = null;
        public static dMessage mOnLostFocus = null;
        public static dMessage mOnEnable = null;
        public static dMessage mOnUpdate = null;

        public static EditorWindow mInstance = null;
        ...
        private void OnGUI()
        {
            ...
            switch(m_Mode)
            {
                case Mode.Builder:
                    m_BuildTab.OnGUI();
                    /*mAssetBundleSettingWindow.position = new Rect(0, 25, position.width, position.height);
                    mAssetBundleSettingWindow.Draw(1);*/
                    break;
                case Mode.Inspect:
                    m_InspectTab.OnGUI(GetSubWindowArea());
                    /*mAssetBundleFixedBundleWindow.position = new Rect(0, 25, position.width, position.height);
                    mAssetBundleFixedBundleWindow.Draw(1);*/
                    break;
                case Mode.Browser:
                default:
