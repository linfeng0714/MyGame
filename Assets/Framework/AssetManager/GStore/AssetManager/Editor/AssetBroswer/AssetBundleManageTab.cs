...
namespace AssetBundleBrowser
{
    ...
    internal class AssetBundleManageTab
    {
        ...
        {
            m_HorizontalSplitterPercent = 0.6f;
        ...
        internal void OnGUI(Rect pos)
        {
            ...
            if (m_BundleTree == null)
            {
                ...
                var headerState2 = AssetBundleTree.CreateDefaultMultiColumnHeaderState();// multiColumnTreeViewRect.width);
                if (MultiColumnHeaderState.CanOverwriteSerializedFields(m_BundleListMCHState, headerState2))
                    MultiColumnHeaderState.OverwriteSerializedFields(m_BundleListMCHState, headerState2);
                m_BundleListMCHState = headerState2;

                m_BundleTree = new AssetBundleTree(m_BundleTreeState, m_BundleListMCHState, this);
            ...
            else
            {
                ...
                if (GUILayout.Button("计算大小", GUILayout.Width(100)))  //  计算原包总大小
                {
                    m_BundleTree.CalculatePackageSize();
                }

                if (GUILayout.Button("小包快照", GUILayout.Width(100)))
                {
                    AlwaysPackedSettings.CaptureLoadedAssetBundle();
                }
                ...
                Rect searchRect = GUILayoutUtility.GetRect(0, pos.width * 0.6f, 16f, 16f, m_SearchStyles[0], GUILayout.MinWidth(65), GUILayout.MaxWidth(300));
                OnGUISearchBar(searchRect);
                ...
                //OnGUISearchBar(new Rect(320, 24, 320, searchHeight));
            ...
            //m_BundleTree.InitDontDestroyAndAlwaysPack();
        }
        ...
        void OnGUISearchBar(Rect rect)
        {
            ...
            //Debug.Log("---search name---"+ m_BundleTree.searchString);
        }
        ...
        {
            //Debug.Log("--SelectedBundles--" + bundles.Count());
